...
namespace Identity.Services
{
    public class AccountService : IAccountService
    {
        ...
        private readonly RoleManager<ApplicationUser> _roleManage;
        private readonly SignInManager<ApplicationUser> _singInManage;
        private readonly JWTSetting _jwtSetting;
        private readonly IDateTimeService _dateTimeService;

        public AccountService(UserManager<ApplicationUser> userManage, RoleManager<ApplicationUser> roleManage = null, IOptions<JWTSetting> jwtSetting = null, IDateTimeService dateTimeService = null, SignInManager<ApplicationUser> singInManage = null)
        {
