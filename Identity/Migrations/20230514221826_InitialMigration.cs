        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Caninos_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VacunadorId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VacunadorId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CaninoId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VacunadorId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VacunadorId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    VacunaId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Caninos_ApplicationUserId",
                table: "Caninos",
